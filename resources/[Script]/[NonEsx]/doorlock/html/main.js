...
window.addEventListener('message', ({data}) => {
    ...
    if(data.type == "display") {
        if(data.text == undefined) {
            ...
            if (data.text == "Locked") {
                doorlock.innerHTML = '<i style="color:orange" class="fas fa-lock">Fermer</i>';
            } else if (data.text == "Unlocked") {
                doorlock.innerHTML = '<i style="color:limegreen" class="fas fa-unlock">ouvert</i>';
            } else if (data.text == "Locking") {
                doorlock.innerHTML = '<i style="color:orange" class="fas fa-lock"><br>Fermer</i>';
            }
