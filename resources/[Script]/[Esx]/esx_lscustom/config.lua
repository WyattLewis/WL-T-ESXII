...
Config.Zones = {
	...
	ls1 = {
		Pos   = { x = 3625.656, y = -6564.368, z = 2190.431},
	...
	ls6 = {
	    Pos   = { x = -221.232, y = -1326.736, z = 29.89},
...
Config.Menus = {
	...
	modSuspension = {
		...
		parent = 'upgrades',
		modType = 15,
		price = {500, 1000, 1500, 2000, 3000}
	},
	modArmor = {
		label = _U('armor'),
		parent = 'upgrades',
		modType = 16,
		price = {9000000, 9000000, 9000000, 9000000, 9000000, 9000000}
	},
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
	...
	modFrontWheelsTypes = {
		...
		modFrontWheelsType11	= _U('rendmonquadfdp'),
	},
	modFrontWheelsType0 = {
		label = _U('sport'),
